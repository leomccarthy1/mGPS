...
Fig S11, Geographic distribution of dbundance for top 25 geo indicator species. Plots will be saved to Outputs/Metasub/Gloabl
...
#png(paste("Species_abundance_",p,".png", sep = ""), width = 12, height = 8, units = "in", res = 600)
  ...
  ggsave(paste("Species_abundance",p,".png", sep = ""),plot = last_plot(),device = NULL,path ="Metasub/Outputs/Global",scale = 1,width = 12,height = 5.1,dpi = 600,limitsize = TRUE,)
